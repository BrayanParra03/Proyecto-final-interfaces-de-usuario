...
<head>
  ...
  <style>
    /* Mejor estilo al estilo Corporación RAYA */
    body {
    ...
    /* Navbar más compacta al hacer scroll (opcional) */
    nav.navbar.scrolled {
      padding-top: 10px;
      padding-bottom: 10px;
...
<!-- NAVBAR FIJA - Agregada clase fixed-top -->
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      <ul class="navbar-nav ms-auto align-items-lg-center">
        ...
        <li class="nav-item"><a class="nav-link" href="consultas.php">Consultas Virtuales</a></li>
      </ul>
...
<!-- Script para efecto al hacer scroll y modo oscuro -->
<script>
